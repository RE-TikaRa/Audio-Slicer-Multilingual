...
from PySide6.QtWidgets import (QFormLayout, QFrame, QGroupBox,
    ...
    QComboBox, QRadioButton, QButtonGroup, QGraphicsView)
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.labelLanguage = QLabel(self.groupBox_2)
        self.labelLanguage.setObjectName(u"labelLanguage")

        self.formLayout.setWidget(5, QFormLayout.LabelRole, self.labelLanguage)

        self.cbLanguage = QComboBox(self.groupBox_2)
        ...
        self.horizontalLayoutOutputFormat = QHBoxLayout()
        self.horizontalLayoutOutputFormat.setObjectName(u"horizontalLayoutOutputFormat")
        self.labelOutputFormat = QLabel(self.groupBox_2)
        self.labelOutputFormat.setObjectName(u"labelOutputFormat")

        self.horizontalLayoutOutputFormat.addWidget(self.labelOutputFormat)

        self.radioButtonWav = QRadioButton(self.groupBox_2)
        self.outputFormatGroup = QButtonGroup(MainWindow)
        self.outputFormatGroup.setObjectName(u"outputFormatGroup")
        self.outputFormatGroup.addButton(self.radioButtonWav)
        self.radioButtonWav.setObjectName(u"radioButtonWav")
        self.radioButtonWav.setText(u"wav")
        self.radioButtonWav.setChecked(True)

        self.horizontalLayoutOutputFormat.addWidget(self.radioButtonWav, 0, Qt.AlignHCenter)

        self.radioButtonFlac = QRadioButton(self.groupBox_2)
        self.outputFormatGroup.addButton(self.radioButtonFlac)
        self.radioButtonFlac.setObjectName(u"radioButtonFlac")
        self.radioButtonFlac.setText(u"flac")

        self.horizontalLayoutOutputFormat.addWidget(self.radioButtonFlac, 0, Qt.AlignHCenter)

        self.radioButtonMp3 = QRadioButton(self.groupBox_2)
        self.outputFormatGroup.addButton(self.radioButtonMp3)
        self.radioButtonMp3.setObjectName(u"radioButtonMp3")
        self.radioButtonMp3.setText(u"mp3")

        self.horizontalLayoutOutputFormat.addWidget(self.radioButtonMp3, 0, Qt.AlignHCenter)


        self.verticalLayout_3.addLayout(self.horizontalLayoutOutputFormat)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelLanguage.setText(QCoreApplication.translate("MainWindow", u"Language", None))
        ...
        self.labelOutputFormat.setText(QCoreApplication.translate("MainWindow", u"Output Format", None))
